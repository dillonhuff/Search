...
class KMeansTests {
	...
	@Test
	def fullKMeansTest() = {
		val v1 = new FeatureVector(Map[String, Double]("x" -> 1.0))
		val v2 = new FeatureVector(Map[String, Double]("x" -> 1.2, "y" -> 0.01))
		val v3 = new FeatureVector(Map[String, Double]("x" -> -12.2, "y" -> -3.4))
		val v4 = new FeatureVector(Map[String, Double]("x" -> -11, "y" -> -3.0))
